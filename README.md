...
- **TypeScript**: لتحسين الأمان والموثوقية.
- **HTML/CSS**: لبناء الهيكل والتصميم الأساسي.
- **Tailwind CSS**: مكتبة لتصميم واجهات المستخدم بشكل سريع ومرن.
- **Swiper**: لعرض السلايدر وعروض الصور بشكل جذاب.
- **Google Maps API**: لعرض خريطة تفاعلية في صفحة الاتصال.
...
- **Swiper**: لعرض السلايدر وعروض الصور.
...
- **EmailJS**: إرسال البريد الإلكتروني من خلال النموذج.
- **React Query**: إدارة البيانات وتحسين الأداء عبر تحميل البيانات بشكل ديناميكي.
- **AOS**: إضافة تأثيرات مرئية جذابة عند التمرير عبر الصفحة.
...
### **الأيقونات المستخدمة لتمثيل المهارات**:

- **React.js**: ![React Icon](https://img.icons8.com/ios/452/react.png)
- **TypeScript**: ![TypeScript Icon](https://img.icons8.com/ios/452/typescript.png)
- **Tailwind CSS**: ![Tailwind CSS Icon](https://img.icons8.com/ios/452/tailwindcss.png)
- **Google Maps API**: ![Google Maps Icon](https://img.icons8.com/ios/452/google-maps.png)
- **Supabase**: ![Supabase Icon](https://img.icons8.com/ios/452/supabase.png)
- **EmailJS**: ![EmailJS Icon](https://img.icons8.com/ios/452/email.png)
- **React Query**: ![React Query Icon](https://img.icons8.com/ios/452/query.png)
- **AOS**: ![AOS Icon](https://img.icons8.com/ios/452/animation.png)
